//#region node_modules/.nitro/vite/services/ssr/assets/cozy-elements-D4oP2MqS.js
/** Cozy preview Web Components runtime. Injected into generated HTML. No CDNs. */
var COZY_SCRIPT_ATTR = "data-cozy-elements";
var COZY_ELEMENTS_SOURCE = `(() => {
...
var SCRIPT_RE = /<script\s+data-cozy-elements\b[^>]*>[\s\S]*?<\/script>/i;
function cozyElementsScriptTag() {
	return `<script ${COZY_SCRIPT_ATTR}>\n${COZY_ELEMENTS_SOURCE}\n<\/script>`;
}
function injectCozyElements(html) {
...
//#endregion
export { injectCozyElements as t };
